...
import com.liulangzheli.ecwitkeyplus.core.config.EcWitkeyPlusWebMvcConfig;
import com.liulangzheli.ecwitkeyplus.shiro.config.ShiroProperties;
...
/**
 * ec-witkey-plus属性配置信息
 * @author liulangzheli
 * @date 2019-08-04
 * @since 1.2.0-RELEASE
 */
@Data
@ConfigurationProperties(prefix = "ec-witkey-plus")
public class EcWitkeyPlusProperties {
    ...
    private EcWitkeyPlusInterceptorProperties interceptor;

    /**
     * 过滤器配置
     */
    @NestedConfigurationProperty
    private EcWitkeyPlusFilterProperties filter;
    ...
    /**
     * 项目静态资源访问配置
     * @see EcWitkeyPlusWebMvcConfig addResourceHandlers
     */
     ...
     */
    @NestedConfigurationProperty
    private EcWitkeyPlusCorsProperties cors = new EcWitkeyPlusCorsProperties();
