...
package com.liulangzheli.ecwitkeyplus.core.aop;
...
import com.liulangzheli.ecwitkeyplus.core.properties.EcWitkeyPlusAopProperties;
...
import com.liulangzheli.ecwitkeyplus.util.Jackson;
import lombok.Data;
...
public abstract class AbstractLogAop {
     ...
     * AOP配置
     */
    protected EcWitkeyPlusAopProperties.LogAopConfig logAopConfig;

    @Autowired
    public void setSpringBootPlusAopProperties(EcWitkeyPlusAopProperties ecWitkeyPlusAopProperties) {
        logAopConfig = ecWitkeyPlusAopProperties.getLog();
    }
