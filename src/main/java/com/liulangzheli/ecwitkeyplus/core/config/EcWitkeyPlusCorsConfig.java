...
import com.liulangzheli.ecwitkeyplus.core.properties.EcWitkeyPlusCorsProperties;
...
@Slf4j
@Configuration
public class EcWitkeyPlusCorsConfig {
     ...
     */
    @Bean
    public FilterRegistrationBean corsFilter(EcWitkeyPlusCorsProperties corsProperties) {
