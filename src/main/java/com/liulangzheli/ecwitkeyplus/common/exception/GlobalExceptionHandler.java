...
public class GlobalExceptionHandler {
     ...
     * @return
     */
    @ExceptionHandler(value = {EcWitkeyPlusException.class})
    @ResponseStatus(HttpStatus.OK)
    public ApiResult springBootPlusExceptionHandler(EcWitkeyPlusException exception) {
        log.error("ecWitkeyPlusException:", exception);
        int errorCode;
        if (exception instanceof BusinessException) {
            ...
            errorCode = ApiCode.EC_WITKEY_PLUS_EXCEPTION.getCode();
        }
