...
package com.liulangzheli.ecwitkeyplus.util;
...
public class PrintApplicationInfo {
    ...
    public static void printTip(){
        ...
        tip.append("                                                                                  \n");
        tip.append("                               !!!准备工作!!!                                      \n");
        tip.append(" 1.请先在MySQL中创建数据库，默认数据库名称为：ec_witkey_plus                        \n");
        tip.append(" 2.数据库脚本在项目docs/mysql_ec_witkey_plus.sql                                       \n");
        tip.append(" 3.请先启动redis服务                                                               \n");
        tip.append(" 4.更多注意事项：请查看: https://ecwitkey.plus                                                                                 \n");
        tip.append("                                                                                  \n");
        tip.append("======================================================================================\n");
    ...
    public static void print(ConfigurableApplicationContext context){
        ...
        log.info("ec-witkey-plus project start success...........");
