...
package com.liulangzheli.ecwitkeyplus.resource.controller;
...
import com.liulangzheli.ecwitkeyplus.util.DownloadUtil;
...
public class DownloadController {
    ...
    public void download(@PathVariable(required = true) String downloadFileName, HttpServletResponse response) throws Exception{
        // 下载目录，既是上传目录
        String downloadDir = ecWitkeyPlusProperties.getUploadPath();
        // 允许下载的文件后缀
        List<String> allowFileExtensions = ecWitkeyPlusProperties.getAllowDownloadFileExtensions();
        // 文件下载，使用默认下载处理器
