...
import com.liulangzheli.ecwitkeyplus.generator.config.EcWitkeyPlusMySqlQuery;
...
public class CodeGenerator {
    ...
    // 生成的类路径
    private static final String PROJECT_PACKAGE_PATH = "com/liulangzheli/ecwitkeyplus";

    // 项目主包路径
    private static final String PARENT_PACKAGE = "com.liulangzheli.ecwitkeyplus";
    ...
    // ############################ 配置部分 start ############################
    // 模块名称
    private static final String MODULE_NAME = "ecwitkey";
    // 作者
    private static final String AUTHOR = "liulangzheli";
    // 生成的表名称
    private static final String TABLE_NAME = "sys_setting";
    // 主键数据库列名称
    private static final String PK_ID_COLUMN_NAME = "settting_id";
    ...
    public static void main(String[] args) {
        ...
        // 设置自定义查询
        dsc.setDbQuery(new EcWitkeyPlusMySqlQuery());
