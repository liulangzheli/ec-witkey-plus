...
-- ----------------------------
create database if not exists ec_witkey_plus character set utf8mb4 COLLATE utf8mb4_general_ci;
...
(
	...
	`id_front`			varchar(1000)     NULL COMMENT '身份证正面',
	`id_back`			varchar(1000)     NULL COMMENT '身份证背面',
	...
	`license_pic`			varchar(30)     NULL COMMENT '营业执照',
