...
## What is ec-witkey-plus?

### A **easy-to-use**, **high-speed**, **high-efficient**, **feature-rich**, **open source** spring boot scaffolding.
> ec-witkey-plus is a background rapid development framework that integrates spring boot common development components.
...
## Java Docs
#### [Java Api Docs](http://liulangzheli.io/ec-witkey-plus-apidocs/)


## Getting started
### Clone ec-witkey-plus
```bash
...
```java
/**
 * ec-witkey-plus Project Main Class
 * @author liulangzheli
 * @since 2018-11-08
 */
@EnableAsync
...
![sys_user_swagger.png](https://raw.githubusercontent.com/liulangzheli/ec-witkey-plus/master/docs/img/sys_user_swagger.png)


## Quick Start
[Quick Start](https://ecwitkey.plus/guide/quick-start.html)
...
> ec-witkey-plus Swagger Document page
